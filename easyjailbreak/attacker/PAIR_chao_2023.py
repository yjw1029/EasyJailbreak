...
from easyjailbreak.metrics.Evaluator.Evaluator_GenerativeGetScore import (
            ...
            for stream in batch:
                ...
                for _ in range(self.max_n_attack_attempts):
                    ...
                    self.attack_model.conversation.messages = (
                        []
                    )  # clear the conversation history generated during mutation.
                ...
                if isinstance(self.target_model, OpenaiModel) or isinstance(
                    self.target_model, vLLMModel
                ):
    ...
    def attack(self, save_path="PAIR_attack_result.jsonl"):
        ...
        logging.info(
            "Jailbreak result saved at {}!".format(
                os.path.join(os.path.dirname(os.path.abspath(__file__)), save_path)
            )
        )
